    ...
    document.addEventListener("deviceready", function(){
        ...
        watch.then(
          ...
          function(result) {
            ...
            var y = result.y;
            var z = result.z;
            if (y > 6.5 && $scope.stage === 1){ //check that phone is standing
                $scope.stage = 2;
            }
        ...
        gyroscope.then(
            ...
            function(result){
                ...
                var y = result.y;
                var z = result.z;
                var isMoving = x > 2.5 || y > 2.5 || z > 2.5;
                if ($scope.stage === 2 && $scope.acceleration.y > 6.5 && isMoving && Object.keys($rootScope.inRangeBeacons).length > 0 && !$scope.modalOpen && $state.current.name === "tab.drag"){
                    console.log(result);
                    console.log("grabbed");
